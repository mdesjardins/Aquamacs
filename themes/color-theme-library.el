...
(defun color-theme-fooble ()
  ...
  (color-theme-install
   '(color-theme-fooble
     ...
     (region ((t (:background "#10561f"))))
     (font-lock-builtin-face ((t (:foreground "#a7bed7"))))
     (font-lock-comment-face ((t (:foreground "#92948f"))))
     (font-lock-function-name-face ((t (:foreground "#fae429"))))
     (font-lock-keyword-face ((t (:foreground "#a7c3e2"))))
     (font-lock-string-face ((t (:foreground "#c299bd"))))
     (font-lock-type-face ((t (:foreground"#b2df86"))))
     (font-lock-variable-name-face ((t (:foreground "#f6f6c6"))))
     (minibuffer-prompt ((t (:foreground "#81a9d5" :bold t))))
     (font-lock-warning-face ((t (:foreground "#feabab" :bold t))))
     )))
(provide 'color-theme-fooble)
